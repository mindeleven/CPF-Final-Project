        ...
        for attempt in range(1, max_retries + 1):
            ...
            try:
                ...
                if self.ib.isConnected():
                    ...
                    # self.contract.conId = 12087792
                    qualified = await self.ib.qualifyContractsAsync(self.contract)
                    self.contract = qualified[0]  # Returns list, take first
                    
                    self.logger.info(
                        f"Contract re-qualified: {self.contract.symbol}"
                    )
